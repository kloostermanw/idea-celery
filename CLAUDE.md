...
**CeleryCompletionContributor** (`src/main/java/eu/kloosterman/ideacelery/completion/CeleryCompletionContributor.java`)
...
**Plugin Services**
- `CeleryApplicationService` - Application-level service (singleton)
- `CeleryProjectService` - Project-level service (one per project)
- `CeleryProjectManagerListener` - Initializes project service when project opens
